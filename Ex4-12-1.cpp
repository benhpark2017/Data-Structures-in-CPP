/**
 * Solutions to Chapter 4, Section 12, Exercise 1, the first part of Horowitz's
 * Fundamentals of Data Structures in C++.
 * 
 * Write C++ code to insert an integer at the beginning of the homogeneous list
 * of Program 4.44.
 */
...
/**
 * Solutions to Chapter 4, Section 12, Exercise 1, the second part of Horowitz's
 * Fundamentals of Data Structures in C++.
 * 
 * Write C++ code to insert an integer at the beginning of the heterogeneous list
 * of Program 4.45.
 */
